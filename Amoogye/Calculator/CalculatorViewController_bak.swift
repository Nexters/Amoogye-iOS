...
class CalculatorViewController_bak: UIViewController {
    enum CalculatorMode {
...
extension CalculatorViewController_bak {
    // MARK: - setup
...
extension CalculatorViewController_bak: NumericKeyboardDelegate {
